...
$output .= '<div '.($row_id ? 'id="'.$row_id.'"' : '') .' class="row '.$mouse.$max_width.$nopadding.$parallax_class.$video.$height.$el_class.vc_shortcode_custom_css_class($css, ' ').'" '.$data.$equal_height.$midnight.'>';
$output .= $bg_video;
