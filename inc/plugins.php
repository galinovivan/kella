...
function thb_register_required_plugins() {
	$plugins = array(
		array(
			'name'     				=> 'Credenza - Extensions', // The plugin name
			'slug'     				=> 'credenza-wp-extensions', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/inc/plugins/credenza-wp-extensions.zip', // The plugin source
