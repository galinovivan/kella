...
<?php
	...
	function process_menu_item( $item ) {
		...
		$args = array(
			...
			'menu-item-menuanchor' => $_menu_item_menuanchor,
			'menu-item-menuicon' => $_menu_item_menuicon
		);
		...
		if ( $id && ! is_wp_error( $id ) )
			...
			update_post_meta( (int) $id, '_menu_item_menuicon', maybe_unserialize( $_menu_item_menuicon ) );
			update_post_meta( (int) $id, '_menu_item_menuanchor', maybe_unserialize( $_menu_item_menuanchor ) );
