...
vc_add_param("vc_row", array(
  ...
  "value" => array(
  	'Light Section' => "light-bg",
  	'Dark Section' => "dark-bg"
  ),
  "description" => "This affects the logo color when the header is over this section. You should still set your section background."
));
vc_add_param("vc_row", array(
	"type" => "textfield",
	"class" => "",
...
vc_map( array(
	...
	"params"	=> array(
	  array(
	      ...
	      "value" => array(
	      	'Grid' => "grid",
	      	'Masonry Style 1' => "style1",
	      	'Masonry Style 2' => "style2",
	      	'Masonry Style 3' => "style3"
	      ),
	  ...
	  array(
	      ...
	      "description" => "Select the layout of the portfolio information",
	      "dependency" => Array('element' => "style", 'value' => array('grid'))
	  ),
	  array(
	      "type" => "dropdown",
...
vc_map( array(
	...
	"params"	=> array(
	  array(
	      ...
	      "description" => "Select the listing type."
	  ),
	  array(
	      "type" => "dropdown",
	      "heading" => "Carousel",
	      ...
	      "description" => "Select yes to display the posts in a carousel.",
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"heading" => "Team Member",
			"param_name" => "type",
			"value" => thb_teammembers(),
			"description" => "Please select which Team Member you would like to add"
		),
	),
