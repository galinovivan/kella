...
class widget_thbtwitter extends WP_Widget { 
	...
	function widget($args, $instance) {
		...
		?>
		<?php echo thb_get_theme_tweets($username, ot_get_option('twitter_bar_consumerkey'), ot_get_option('twitter_bar_consumersecret'), ot_get_option('twitter_bar_accesstoken'), ot_get_option('twitter_bar_accesstokensecret'), $notweets); ?>
		<?php
		echo $after_widget;
	}
